...
describe('NotFoundArtistComponent', () => {
  ...
  it('should render title in a h2 tag', () => {
    ...
    expect(compiled.querySelector('h2').textContent).toContain('Artist not found, please try another name');
  });
  ...
  it('should render content a in h6 tag ', () => {
    ...
    fixture.detectChanges();
    const compiled = fixture.debugElement.nativeElement;
    expect(compiled.querySelector('h6').textContent).toContain('Example: Maroon 5, Jack Johnson, Dio, Lauv');
  });
  ...
  it('should render content a in p tag ', () => {
    ...
    fixture.detectChanges();
    const compiled = fixture.debugElement.nativeElement;
    expect(compiled.querySelector('p').textContent).toContain('Be careful about spelling and tildes.');
  });
});
