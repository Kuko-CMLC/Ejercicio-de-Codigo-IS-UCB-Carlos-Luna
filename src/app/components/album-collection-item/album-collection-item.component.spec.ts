...
describe('AlbumCollectionItemComponent', () => {
  ...
  it('should return the image when input is not null,undefined or null', () => {
    const mockAlbumCollectionItem:albumCollectionModel = {
      ...
      artworkUrl100: "https://is5-ssl.mzstatic.com/image/thumb/Music3/v4/4b/ab/c6/4babc680-e3a2-cb42-f2c1-80af61305bb6/source/100x100bb.jpg",
      collectionName: "Independiente",
      collectionPrice: "9.99",
      artworkUrl60: "https://someImage.png"
    }
    const resultImage = component.validateHasAlbumImage(mockAlbumCollectionItem.artworkUrl100);
